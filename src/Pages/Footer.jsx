...
const Footer = () => {
  // Optionally use location if you need to trigger effects on route change
  const location = useLocation();

  useEffect(() => {
    // Scroll to the top and initialize AOS when the route changes
    window.scrollTo(0, 0);
      ...
      <div className={styles.container}>
        <div className={styles.row}>
          ...
          <div className={styles.col}>
            <h4>Contact Us</h4>
            <p>
              <a href="mailto:info@zeitgeistjntukcse.com">
                info@zeitgeistjntukcse.com
              </a>
            </p>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.socialLinks}>
              <a
                href="https://www.facebook.com/share/1B67aRdxyu/?mibextid=wwXIfr"
                target="_blank"
                rel="noreferrer"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.linkedin.com/in/zeitgeist-cse-a89868349"
                target="_blank"
                rel="noreferrer"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://x.com/zeitgeist_2k25"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                href="https://www.instagram.com/zeitgeist_2k25"
                target="_blank"
                rel="noreferrer"
